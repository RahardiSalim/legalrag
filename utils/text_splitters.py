...
from config.constants import HIERARCHY_LEVELS, LEGAL_PATTERNS, TEXT_SEPARATORS
    ...
    def _parse_legal_structure(self, document: Document) -> List[LegalChunk]:
        ...
        for line_num, line in enumerate(lines):
            ...
            current_hierarchy = self._update_hierarchy(
                current_hierarchy, pattern_name, level, section_number, section_title, line_num
            )
